...
public class Server extends Thread {
    ...
    Server(String stid)
    {
        if ( !(Network.getServerConnectionStatus().equals("connected")))
        {
            ...
            System.out.println("\n Inializing the Accounts database ...: " + stid);
            initializeAccounts( );
            System.out.println("\n Connecting server to network ...: " + stid);
            if (!(Network.connect(Network.getServerIP())))
            {
                System.out.println("\n Terminating server application, network unavailable: " + stid);
                System.exit(0);
            }
        }
        else
    ...
    public void run()
    {
        ...
        long serverStartTime2 = 0, serverEndTime2 = 0;

        if(this.serverThreadId.equals("Thread1")) {
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA11");
            this.setServerThreadRunningStatus1("Active");
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA21");
            serverStartTime1 = System.currentTimeMillis();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA31");
            Transactions trans = new Transactions();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA41");
            processTransactions(trans);
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA51");
            serverEndTime1 = System.currentTimeMillis();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA61");
            this.setServerThreadRunningStatus1("Terminated");
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA71");
            Thread.yield();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA81");
        }

        if(this.serverThreadId.equals("Thread2")) {
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA12");
            this.setServerThreadRunningStatus2("Active");
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA22");
            serverStartTime2 = System.currentTimeMillis();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA32");
            Transactions trans = new Transactions();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA42");
            processTransactions(trans);
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA52");
            serverEndTime2 = System.currentTimeMillis();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA62");
            this.setServerThreadRunningStatus2("Terminated");
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA72");
            Thread.yield();
            System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA82");
        }
