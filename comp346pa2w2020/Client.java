...
public class Client extends Thread {
    ...
    public void readTransactions()
    {
        ...
        try
        {
            inputStream = new Scanner(new FileInputStream("C:\\Users\\anthc\\Desktop\\COMP346A2\\COMP346A2\\comp346pa2w2020\\transaction2.txt"));
        }
    ...
    public void run()
    {
        ...
        long sendClientStartTime, sendClientEndTime = 0, receiveClientStartTime = 0, receiveClientEndTime = 0;
        ...
        if (clientOperation.equals("sending"))
        {
            ...
            System.out.println("\n Terminating sending client thread - " + " Running time " +  (sendClientEndTime - sendClientStartTime));
            ...
            System.out.println("\n Terminating receiving client thread - " + " Running time " +  (receiveClientEndTime - receiveClientStartTime));
        }
    }
