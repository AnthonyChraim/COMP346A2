...
public class Network extends Thread {
    ...
    private static Semaphore  transferInSemaphore = new Semaphore(1);
    private static Semaphore transferOutsemaphore = new Semaphore(1);
    private static Semaphore receiveSemaphore = new Semaphore(1);
    /**
    ...
    public void run()
    {
        ...
        while (true)
        {
            if(getNetworkStatus().equals("disconnected")){
